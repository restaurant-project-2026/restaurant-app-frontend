// URLs des photos Unsplash utilisées comme images de fond et d'illustration
// l'API ne fournit pas de photos pour les plats donc on utilise des images génériques
...
// associe chaque type de catégorie à une image par défaut
...
// retourne la photo hero utilisée en fond sur la page d'accueil
export function getRestaurantHeroImage() {
  return RESTAURANT_HERO;
}

// retourne la photo d'intérieur utilisée dans la section "Notre histoire"
export function getRestaurantInteriorImage() {
  return RESTAURANT_INTERIOR;
}

// Choisit l'image à afficher sur une carte plat en fonction du nom de la catégorie
// si aucun mot-clé ne correspond on retourne l'image par défaut
